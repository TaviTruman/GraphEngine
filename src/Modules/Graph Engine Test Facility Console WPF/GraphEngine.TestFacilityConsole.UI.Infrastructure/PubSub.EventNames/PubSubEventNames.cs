 ...
 * --------------------------------------------------------------------------------*/
namespace GraphEngine.TestFacilityConsole.UIInfrastructure.PubSub.EventNames
{
    public static class PubSubEventNames
    {
        public static string SemanticEvent = @"SemanticEvent";
    }
}